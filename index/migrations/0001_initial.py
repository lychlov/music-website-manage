# Generated by Django 2.2.5 on 2022-12-06 20:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Song',
            fields=[
                ('song_id', models.IntegerField(primary_key=True, serialize=False, verbose_name='歌曲ID')),
                ('song_title', models.CharField(max_length=50, verbose_name='歌名')),
                ('song_artist', models.CharField(max_length=50, verbose_name='歌手')),
                ('song_artist_id', models.IntegerField(verbose_name='歌手ID')),
                ('song_album', models.CharField(max_length=100, verbose_name='专辑')),
                ('song_album_id', models.IntegerField(verbose_name='专辑ID')),
                ('song_img', models.URLField(verbose_name='歌曲图片')),
                ('song_img_file_path', models.CharField(max_length=100, verbose_name='歌曲图片文件')),
                ('song_file_path', models.CharField(max_length=100, verbose_name='歌曲文件')),
                ('song_download_url', models.URLField(verbose_name='下载地址')),
